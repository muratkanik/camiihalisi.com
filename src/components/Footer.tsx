...
import { getSettings, buildWaUrl, buildMainSiteUrl } from "@/lib/settings";
...
export default async function Footer({ locale }: FooterProps) {
  ...
  const MAIN_SITE_URL = buildMainSiteUrl(settings, "footer");
  const WA_URL = buildWaUrl(settings, "footer");
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex gap-2">
                ...
                <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-colors text-xs font-bold text-[#F7F3EC]/70" aria-label="Instagram">
                  IG
                </a>
                <a href={LINKEDIN_URL} target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-white/10 hover:bg-white/20 rounded-lg flex items-center justify-center transition-colors text-xs font-bold text-[#F7F3EC]/70" aria-label="LinkedIn">
                  in
                </a>
              </div>
            </div>
