...
const FALLBACK_COMMON: CommonData = {
  manufacturingMethod: { tr: "Wilton Çift Karşılıklı Dokuma Teknolojisi", en: "Wilton Face-to-Face Weaving Technology", de: "Wilton-Doppelgesicht-Webtechnologie", fr: "Technologie de tissage Wilton face à face", ar: "تقنية نسج ويلتون وجهًا لوجه", ru: "Технология двустороннего ткачества Wilton" },
  manufacturingTechnology: { tr: "Van de Wiele Elektronik Jakarlı Dokuma Sistemi", en: "Van de Wiele Electronic Jacquard Weaving System", de: "Van de Wiele Elektronisches Jacquard-Websystem", fr: "Système de tissage Jacquard électronique Van de Wiele", ar: "نظام نسج جاكار إلكتروني من فان دي ويله", ru: "Электронная жаккардовая ткацкая система Van de Wiele" },
  pileYarn: { tr: "%100 Birinci Kalite Akrilik", en: "100% First Quality Acrylic", de: "100% Acryl erster Qualität", fr: "100% acrylique de première qualité", ar: "100% أكريليك من الدرجة الأولى", ru: "100% акрил высшего качества" },
  weavingSystem: { tr: "1/1 Yüksek Yoğunluklu Dokuma Sistemi", en: "1/1 High-Density Weaving System", de: "1/1 Hochdichtes Websystem", fr: "Système de tissage haute densité 1/1", ar: "نظام نسج عالي الكثافة 1/1", ru: "Система ткачества высокой плотности 1/1" },
  weavingWidth: "400 cm",
  row: "420 / m",
  backing: { tr: "%100 Premium Kalite Jüt", en: "100% Premium Grade Jute", de: "100% Jute in Premiumqualität", fr: "100% jute de qualité premium", ar: "100% خيش فاخر", ru: "100% джут премиум-класса" },
  yarnCount: "15/3",
  warpYarn: { tr: "Pamuk", en: "Cotton", de: "Baumwolle", fr: "Coton", ar: "قطن", ru: "Хлопок" },
  tolerance: { tr: "Tüm ölçüm değerlerinde ±%5 üretim toleransı uygulanır.", en: "A ±5% manufacturing tolerance applies to all measurement values.", de: "Für alle Messwerte gilt eine Fertigungstoleranz von ±5%.", fr: "Une tolérance de fabrication de ±5% s'applique à toutes les valeurs mesurées.", ar: "يتم تطبيق هامش تصنيع ±5% على جميع القيم القياسية.", ru: "Ко всем значениям измерений применяется производственный допуск ±5%." },
  description: {
  ...
  performanceFeatures: [
    { tr: "Işığa ve Solmaya Karşı Dayanıklı", en: "Light Resistant", de: "Lichtbeständig", fr: "Résistant à la lumière", ar: "مقاوم للضوء والبهتان", ru: "Светостойкий" },
    { tr: "Bakteri Gelişimine Karşı Dayanıklı", en: "Anti-Bacterial", de: "Antibakteriell", fr: "Antibactérien", ar: "مقاوم لنمو البكتيريا", ru: "Антибактериальный" },
    { tr: "Koku Oluşumuna Karşı Dayanıklı", en: "Odor Resistant", de: "Geruchsresistent", fr: "Résistant aux odeurs", ar: "مقاوم لتكون الروائح", ru: "Устойчивый к запахам" },
    { tr: "Antistatik Özellikli", en: "Anti-Static", de: "Antistatisch", fr: "Antistatique", ar: "خاصية مضادة للكهرباء الساكنة", ru: "Антистатический" },
  ],
  usage: {
    underlay: { tr: "Altlık ile Kullanıma Uygundur", en: "Suitable for Use with Underlay", de: "Geeignet für die Verwendung mit Unterlage", fr: "Adapté à l'utilisation avec sous-couche", ar: "مناسب للاستخدام مع الطبقة السفلية", ru: "Подходит для использования с подложкой" },
    vacuum: { tr: "Düzenli Vakumlu Temizliğe Uygundur", en: "Suitable for Frequent Vacuuming", de: "Geeignet für häufiges Staubsaugen", fr: "Adapté à un aspirateur fréquent", ar: "مناسب للتنظيف المتكرر بالمكنسة الكهربائية", ru: "Подходит для частой чистки пылесосом" },
    serviceLife: { tr: "Kullanım Ömrü: 30 Yıl", en: "Service Life: 30 Years", de: "Nutzungsdauer: 30 Jahre", fr: "Durée de vie : 30 ans", ar: "العمر الافتراضي: 30 عامًا", ru: "Срок службы: 30 лет" },
    warranty: { tr: "Ürün Garantisi: Türkiye Mevzuatına Uygun Olarak 2 Yıl", en: "Product Warranty: 2 Years (in accordance with Turkish legislation)", de: "Produktgarantie: 2 Jahre (gemäß türkischer Gesetzgebung)", fr: "Garantie produit : 2 ans (conformément à la législation turque)", ar: "ضمان المنتج: عامان (وفقًا للتشريعات التركية)", ru: "Гарантия на продукт: 2 года (согласно турецкому законодательству)" },
  },
};
...
const COPY: Record<Locale, {
  ...
  ru: {
    ...
    height: "Высота ворса",
    pitch: "Плотность по утку",
    points: "Количество узлов",
    weight: "Общий вес",
    row: "Плотность по основе",
    weavingWidth: "Ширина ткачества",
    manufacturingMethod: "Метод производства",
    manufacturingTechnology: "Технология производства",
    pileYarn: "Ворсовая пряжа",
    weavingSystem: "Система ткачества",
    backing: "Основа",
    yarnCount: "Номер пряжи",
    warpYarn: "Нить основы",
    download: "Скачать паспорт PDF",
    tabSpecs: "Технические данные",
    tabDescription: "Описание продукта",
    tabPerformance: "Производительность и использование",
    note: "Свяжитесь с нашей технической командой для рекомендаций по качеству для конкретного проекта.",
  },
};
