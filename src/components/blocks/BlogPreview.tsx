...
const FEATURED_POSTS: BlogPost[] = [
  {
    ...
    excerpt:
      "Cami halısı seçerken dikkat edilmesi gereken kriterler: malzeme, desen, ölçü ve bütçe planlaması. Uzman önerileriyle doğru seçimi yapın.",
    category: "Rehber",
    readTime: "8 dk okuma",
  ...
  },
  {
    ...
    excerpt:
      "İki popüler cami halısı türünün avantaj ve dezavantajları, fiyat-performans analizi ve hangi cami için hangisi uygun sorusunun yanıtı.",
  ...
  },
  {
    ...
    excerpt:
      "Cami halınızın ömrünü uzatmak için yapılması ve yapılmaması gerekenler. Profesyonel temizlik önerileri ve günlük bakım ipuçları.",
    category: "Bakım",
    readTime: "5 dk okuma",
    ...
    <section className="section bg-white">
      <div className="container-site">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-end justify-between gap-4 mb-12">
          <div>
            <span className="badge badge-gold mb-3">Bilgi Merkezi</span>
