  ...
  return (
    <>
      ...
      <main id="main-content">
              ...
              {VALUES.map((v, i) => {
                ...
                return (
                  <div key={i} className="p-6 rounded-2xl bg-[#F0FDFE] border border-[#B2EBF2] text-center">
                    <div className="w-12 h-12 rounded-xl bg-[#0097A7]/10 flex items-center justify-center mx-auto mb-4">
        ...
        <section className="section bg-[#F0FDFE]">
          <div className="container-site">
            ...
            <div className="relative max-w-3xl mx-auto">
              {/* Dikey çizgi */}
              <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#C9972B] to-[#0097A7]" />
              <div className="space-y-8">
                {MILESTONES.map((m, i) => (
                  <div key={i} className="flex gap-8 items-start relative">
                    {/* Yıl dairesi */}
                    <div className="w-16 h-16 rounded-full bg-[#0097A7] border-4 border-[#C9972B] flex items-center justify-center flex-shrink-0 z-10">
        ...
        {/* ── Bu Site Hakkında ── */}
        <section className="section-sm bg-[#0097A7]/5 border-y border-[#B2EBF2]">
          <div className="container-site">
            <div className="max-w-2xl mx-auto text-center">
              <h2
                className="text-2xl font-bold text-[#0097A7] mb-3"
                style={{ fontFamily: "'Cormorant Garamond', serif" }}
              >
                Bu Site Hakkında
              </h2>
