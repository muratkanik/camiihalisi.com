  ...
  return (
    <>
      ...
      <main id="main-content">
          ...
          <div className="container-site">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-12">
              {CARPET_TYPES.map((carpet) => (
                ...
                >
                  <h3 className="font-bold text-[#0097A7] mb-2 group-hover:text-[#C9972B] transition-colors">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={faq.q} className="bg-[#F0FDFE] rounded-xl border border-[#B2EBF2] p-5">
                    <h3 className="font-semibold text-[#0097A7] mb-2">{faq.q}</h3>
        ...
        <section className="section bg-[#F0FDFE]">
          <div className="container-site">
            <h2 className="text-xl font-bold text-[#0097A7] mb-6" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
            ...
            <div className="flex flex-wrap gap-2">
              {ALL_CITIES.filter((c) => c.type === "il" && c.slug !== sehir).slice(0, 20).map((c) => (
                <Link
                  ...
                  className="text-sm bg-white border border-[#B2EBF2] text-[#6B6355] hover:text-[#0097A7] hover:border-[#C9972B]/40 px-3 py-1.5 rounded-lg transition-colors"
                >
                  {c.name} Cami Halısı
                </Link>
              ))}
