...
const QUICK_KEYWORDS = [
  "cami halısı", "akrilik cami halısı", "yün cami halısı",
  "cami halısı fiyatları", "cami halısı modelleri", "özel cami halısı", "cami halısı temizleme",
];
    ...
    <div className="max-w-4xl">
        ...
        <>
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-xs text-slate-400 mt-0.5">{sections.length} bölüm · Grok-3</p>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-white/70 text-sm mb-4">
                  Grok-3, rakip analizine göre "{analyzed}" için 1000+ kelimelik, SEO uyumlu tam bir blog yazısı oluşturur.
                </p>
      ...
      {!loading && sections.length === 0 && !error && (
        <div className="text-center py-16 text-slate-400">
          ...
          <p className="text-sm mt-1">Grok AI analiz eder → Blog yazar → Sayfanıza uygular</p>
        </div>
      )}
    </div>
  );
