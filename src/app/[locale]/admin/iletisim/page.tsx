    ...
    <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 overflow-hidden mb-6">
      ...
      >
        <div className="flex items-center gap-3">
          <Inbox className="w-5 h-5 text-[#006064]" />
        ...
        <div className="flex items-center gap-2">
          {unread > 0 && (
            <button
              ...
              className="flex items-center gap-1 text-xs text-slate-500 hover:text-[#006064] px-2 py-1 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
            >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {sub.message && (
                      <button
                        ...
                        className="mt-1 text-xs text-[#006064] hover:underline"
                      >
                  ...
                  <div className="flex items-center gap-1 flex-shrink-0">
                    {!sub.read && (
                      <button onClick={() => action("mark_read", sub.id)} title="Okundu işaretle"
                        className="p-1.5 rounded-lg text-slate-400 hover:text-[#006064] hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors">
