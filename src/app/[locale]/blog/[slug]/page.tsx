                        ...
                        <ul key={i} className="space-y-2 my-4">
                          {items.map((item, j) => (
                            <li key={j} className="flex items-start gap-2.5 text-[#4A4035]">
                              ...
                              <span dangerouslySetInnerHTML={{ __html: item.replace("- ", "").replace(/\*\*(.+?)\*\*/g, '<strong class="font-semibold text-[#1A1A1A]">$1</strong>') }} />
                            </li>
                          ))}
                        </ul>
                      );
                        ...
                        <ol key={i} className="space-y-2 my-4 ml-4">
                          {items.map((item, j) => (
                            <li key={j} className="text-[#4A4035] list-decimal ml-2"
                              dangerouslySetInnerHTML={{ __html: item.replace(/^\d+\.\s/, "").replace(/\*\*(.+?)\*\*/g, '<strong class="font-semibold text-[#1A1A1A]">$1</strong>') }}
                            />
                          ))}
                        </ol>
                      );
                    ...
                    return (
                      <p
                        ...
                        dangerouslySetInnerHTML={{
                          __html: para.replace(/\*\*(.+?)\*\*/g, '<strong class="font-semibold text-[#1A1A1A]">$1</strong>'),
                        }}
                      />
                    );
                  })}
